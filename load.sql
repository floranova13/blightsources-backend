...
WITH ins (name, subcategory_name) AS
( VALUES
  ( 'forslone', 'blightfoils'),
  ( 'erecombe', 'blightfoils'),
  ( 'voidshimmer', 'blightfoils'),
  ( 'apertrite', 'crystali'),
  ( 'meartite', 'crystali'),
  ( 'digitrite', 'crystali'),
  ( 'charke', 'leylodes'),
  ...
  ( 'purivat', 'lifeblight'),
  ( 'mirivat', 'lifeblight'),
  ( 'perceptyde', 'blightvenoms'),
  ( 'residux', 'blightvenoms'),
  ( 'falefate', 'blightvenoms'),
  ( 'blissburn', 'blightmares'),
  ( 'red agony', 'blightmares'),
  ( 'pulsepox', 'blightmares'),
  ( 'mystic', 'rushblight'),
  ( 'surge', 'rushblight'),
  ( 'edge', 'rushblight'),
  ( 'lasperr', 'miasmeta'),
  ( 'manaphage', 'miasmeta'),
  ( 'ominox', 'miasmeta'),
  ( 'nullmist', 'blightmists'),
  ( 'magnimist', 'blightmists'),
  ( 'intermist', 'blightmists'),
  ( 'shrineflower', 'blightblooms'),
  ( 'hydrobloom', 'blightblooms'),
  ( 'shimmering nightblight', 'blightblooms'),
  ( 'whitespire', 'blightpillars'),
  ( 'greyspire', 'blightpillars'),
  ( 'blackspire', 'blightpillars'),
  ( 'silverclutch', 'blightsnarls'),
  ( 'wenderweave', 'blightsnarls'),
  ( 'darkcoil', 'blightsnarls'),
  ( 'darkcoil', 'blightshrooms'),
  ( 'metashroom', 'blightshrooms'),
  ( 'tranceloom', 'blightshrooms'),
  ( 'trickelpus', 'blightbleeds'),
  ( 'rockmole', 'blightbleeds'),
  ( 'achromatic ooze', 'blightbleeds'),
  ( 'sporesprawl1', 'sporesprawls'),
  ( 'sporesprawl2', 'sporesprawls'),
  ( 'sporesprawl3', 'sporesprawls'),
  ( 'token1', 'tokens'),
  ( 'token2', 'tokens'),
  ( 'token3', 'tokens'),
  ( 'locus1', 'loci'),
...
SELECT 
  ins.name, subcategories.category_id, subcategories.id
FROM subcategories
JOIN ins
